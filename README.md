...
Due to GitHub file size limitations (dataset > 100MB), dataset files are excluded from the repository using `.gitignore`.

Note: Model files (`.pkl`) are also excluded because they can be regenerated by running `train_model.py`.
